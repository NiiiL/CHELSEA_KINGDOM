...
const PLAYERS = [
  ...
  { id:"B4",country:"Côte d'Ivoire",cn:"象牙海岸",player:"DROGBA",concept:"Akan King",conceptCN:"阿肯族国王",color:"#E8DDD0",accent:"#5D6D7E",cName:"Ivory",cNameCN:"象牙白",apps:381,goals:164,yrs:"2004-15",pos:"FW",alts:[],hasImg:true, desc: "[Placeholder] Heritage info for this country. Please update later.", descCN: "[占位符] 这里将包含该国国家与文化的详细描述，请在后续更新文案。", dotColor: "#f78000ff" },
  { id:"B5",country:"Croatia",cn:"克罗地亚",player:"KOVAČIĆ",concept:"Adriatic King",conceptCN:"亚得里亚海之王",color:"#70B8C0",accent:"#EAEDED",cName:"Adriatic",cNameCN:"亚得里亚海",apps:221,goals:4,yrs:"2018-23",pos:"MF",alts:[],hasImg:true, desc: "[Placeholder] Heritage info for this country. Please update later.", descCN: "[占位符] 这里将包含该国国家与文化的详细描述，请在后续更新文案。", dotColor: "#181797ff" },
  { id:"B6",country:"Czechia",cn:"捷克",player:"ČECH",concept:"Bohemian King",conceptCN:"波希米亚国王",color:"#7090B0",accent:"#E74C3C",cName:"Bohemian Blue",cNameCN:"波希米亚蓝",apps:494,goals:0,yrs:"2004-15",pos:"GK",alts:[],hasImg:true, desc: "[Placeholder] Heritage info for this country. Please update later.", descCN: "[占位符] 这里将包含该国国家与文化的详细描述，请在后续更新文案。", dotColor: "#11457eff" },
  ...
  { id:"C3",country:"Egypt",cn:"埃及",player:"M. SALAH",concept:"Pharaoh",conceptCN:"古埃及法老",color:"#D4BC9C",accent:"#4A5D6B",cName:"Nile Sand",cNameCN:"尼罗沙",apps:65,goals:5,yrs:"2014-16",pos:"FW",alts:[],hasImg:true, desc: "[Placeholder] Heritage info for this country. Please update later.", descCN: "[占位符] 这里将包含该国国家与文化的详细描述，请在后续更新文案。", dotColor: "#dca901ff" },
  ...
  { id:"G5",country:"Uruguay",cn:"乌拉圭",player:"POYET",concept:"Gentleman King",conceptCN:"绅士国王",color:"#90C0D8",accent:"#FFFFFF",cName:"Celeste",cNameCN:"天蓝",apps:145,goals:49,yrs:"1997-01",pos:"MF",alts:[],hasImg:true, desc: "[Placeholder] Heritage info for this country. Please update later.", descCN: "[占位符] 这里将包含该国国家与文化的详细描述，请在后续更新文案。", dotColor: "#0038a8ff" },
              ...
              <div className="custom-scrollbar flex-1 relative flex flex-col bg-[#fbfaf9]" style={{ overflowY: 'overlay' as any }}>
                ...
                <div className="p-6 md:p-10 flex flex-col gap-10 z-20">
                  ...
                  <div id="section-stats" className="flex gap-4 scroll-mt-6 mb-2">
                    {[
                      ...
                      <div key={i} className="bg-[#ECEEF2] aspect-[2/1] px-2 flex-1 text-center rounded-none flex flex-col items-center justify-center">
                        {SHOW_IMG.has(sel.country) && (
                          <div className="text-[32px] font-salo text-black leading-none tracking-[3.2px]">{s.v}</div>
                        )}
                  ...
                  <div id="section-color" className="flex gap-6 items-stretch scroll-mt-6">
                    <div className="aspect-square shrink-0 rounded-none shadow-inner" style={{ backgroundColor: sel.color }} />

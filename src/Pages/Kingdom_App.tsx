...
const SHOW_IMG = new Set([
    "Albania", "USA", "Israel", "Finland", "Bosnia", "Canada", "Denmark", "DR Congo", "Ghana", "Iceland",
    "Peru", "Scotland", "Serbia", "Croatia", "Czechia", "Uruguay", "Cameroon", "Jamaica", "Ecuador",
    "Burkina Faso", "Egypt", "IvoryCoast", "Switzerland", "Russia", "Gabon", "N. Zealand", "S. Africa", "Wales",
    "Ireland", "Norway", "Morocco", "Netherlands", "N. Ireland", "Australia"
]);
